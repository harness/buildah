...
func (t fileTransport) ValidatePolicyConfigurationScope(scope string) error {
...
// fileReference is an ImageReference for directory paths.
...
// fileTransport.ParseReference; callers who intentionally deal with directories
...
func (ref fileReference) DockerReference() reference.Named {
	return nil
}
...
func (ref fileReference) PolicyConfigurationNamespaces() []string {
	res := []string{}
	...
	// and rejected by fileTransport.ValidatePolicyConfigurationScope above.
	return res
}
...
func (ref fileReference) DeleteImage(ctx context.Context, sys *types.SystemContext) error {
	return errors.Errorf("Deleting images not implemented for dir: images")
}

// manifestPath returns a path for the manifest within a directory using our conventions.
func (ref fileReference) manifestPath(instanceDigest *digest.Digest) string {
...
func (ref fileReference) layerPath(digest digest.Digest) string {
	// FIXME: Should we keep the digest identification?
	return filepath.Join(ref.path, digest.Encoded())
}

func (ref fileReference) blobRootPath() string {
	return filepath.Join(ref.path, "..", "blobs")
}

// blobPath returns a path for a layer tarball within a directory using our conventions.
func (ref fileReference) blobPath(digest digest.Digest) string {
	// FIXME: Should we keep the digest identification?
	return filepath.Join(ref.path, "..", "blobs", digest.Encoded())
}

// signaturePath returns a path for a signature within a directory using our conventions.
func (ref fileReference) signaturePath(index int, instanceDigest *digest.Digest) string {
	if instanceDigest != nil {
...
func (ref fileReference) versionPath() string {
